...
4. **Data Files**:
   - `csconfs/data/conferences.json`: one record per conference edition (series metadata, dates, deadlines, place, chairs, links, `estimated`/`verified`). See MAINTENANCE.md §5 "Local schema".
